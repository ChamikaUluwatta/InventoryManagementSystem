...
function SheetContent({
  ...
  const sizeClasses: Record<string, string> = {
    ...
    md: 'data-[side=left]:w-3/4 data-[side=right]:w-3/4 data-[side=left]:sm:max-w-md data-[side=right]:sm:max-w-md',
    lg: 'data-[side=left]:w-3/4 data-[side=right]:w-3/4 data-[side=left]:sm:max-w-lg data-[side=right]:sm:max-w-lg',
    xl: 'data-[side=left]:w-3/4 data-[side=right]:w-3/4 data-[side=left]:sm:max-w-xl data-[side=right]:sm:max-w-xl',
    '2xl': 'data-[side=left]:w-3/4 data-[side=right]:w-3/4 data-[side=left]:sm:max-w-2xl data-[side=right]:sm:max-w-2xl',
    '3xl': 'data-[side=left]:w-3/4 data-[side=right]:w-3/4 data-[side=left]:sm:max-w-3xl data-[side=right]:sm:max-w-3xl',
    '4xl': 'data-[side=left]:w-3/4 data-[side=right]:w-3/4 data-[side=left]:sm:max-w-4xl data-[side=right]:sm:max-w-4xl',
    full: 'data-[side=left]:w-full data-[side=right]:w-full data-[side=left]:max-w-full data-[side=right]:max-w-full',
    auto: 'data-[side=left]:w-fit data-[side=right]:w-fit data-[side=left]:max-w-[90vw] data-[side=right]:max-w-[90vw] sm:data-[side=left]:max-w-[75vw] sm:data-[side=right]:max-w-[75vw]',
  }
