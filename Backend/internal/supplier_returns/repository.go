...
type SupplierReturnRepository interface {
	Create(ctx context.Context, req *CreateSupplierReturnRequest) (*SupplierReturn, error)
	GetByID(ctx context.Context, id int) (*SupplierReturn, error)
	GetAll(ctx context.Context) ([]SupplierReturn, error)
	UpdateStatus(ctx context.Context, id int, status ReturnStatus) (*SupplierReturn, error)
...
func (r *repository) Create(ctx context.Context, req *CreateSupplierReturnRequest) (*SupplierReturn, error) {
...
func (r *repository) GetByID(ctx context.Context, id int) (*SupplierReturn, error) {
	headerQuery := `
	...
	result, err := pgx.CollectOneRow(headRows, pgx.RowToStructByName[SupplierReturn])
	if err != nil {
		return nil, apperror.Internal("Internal Server Error", err)
	}
	...
	items, err := pgx.CollectRows(itemRows, pgx.RowToStructByName[SupplierReturnItem])
	if err != nil {
		return nil, apperror.Internal("Internal Server Error", err)
	}
...
func (r *repository) GetAll(ctx context.Context) ([]SupplierReturn, error) {
	query := `
	...
	returns, err := pgx.CollectRows(rows, pgx.RowToStructByName[SupplierReturn])
	if err != nil {
		return nil, apperror.Internal("Internal Server Error", err)
	}
...
func (r *repository) UpdateStatus(ctx context.Context, id int, status ReturnStatus) (*SupplierReturn, error) {
	query := `
	...
	updated, err := pgx.CollectOneRow(rows, pgx.RowToStructByName[SupplierReturn])
	if err != nil {
		return nil, apperror.Internal("Internal Server Error", err)
	}
